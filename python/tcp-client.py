...
class TCPClient(object):
    '''
    TCPClient - class for creating connection between server and RPi.
    ...
    def __init__(self):
        """
        Creates TCPClient instance with context and server_socket.
        """
    ...
    def create_socket(self):
        """
        Initializes context and client_socket. Sets client_socket to be 
        a TCP socket.
        """
